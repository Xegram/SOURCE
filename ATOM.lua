...
Start_Source = "⏎ مــرحـبـا انا بوت اسمي "..NameBot.."\n⏎ اختصاصي حماية المجموعات\n⏎ من التفليش والسبام والخخ .. . ،\n⏎ تفعيلي سهل ومجانا فقط قم برفعي ادمن في مجموعتك وارسل امر ↫ تفعيل\n⏎ سيتم رفع الادمنيه والمنشئ تلقائيا"
end 
...
local YOQText = (ATOMDEV:get(OQ.."YOQ:Text:BotWelcome") or "⏎ مــرحـبـا انا بوت اسمي "..NameBot.."\n⏎ حالة المجموعه ↫ "..BotText.."\n𖡦-----------------------------𖡦")
...
{{text = '⌁ HEPIC - هــيـبـكــ .',url="t.me/HEPIC"}},
}
